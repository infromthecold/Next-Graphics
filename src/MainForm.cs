...
namespace NextGraphics
{
	public partial class MainForm : Form, RemapCallbacks, ExportCallbacks
	{
		...
		private List<ImageForm> imageForms = new();
		private readonly List<ImageForm> tilemapForms = new List<ImageForm>();
		private InfoForm infoForm = new();

		private ImageForm rebuildTilesForm = null;

		private readonly PaletteForm paletteForm = new();
		private readonly PaletteOffsetForm offsetPanel = new();

		private readonly SaveFileDialog projectSaveDialog = new();
		private readonly OpenFileDialog projectOpenDialog = new();
		private readonly OpenFileDialog batchProjectDialog = new();
		private readonly SaveFileDialog outputFilesDialog = new();
		private readonly OpenFileDialog addImagesDialog = new();
		private readonly OpenFileDialog addTilemapsDialog = new();
